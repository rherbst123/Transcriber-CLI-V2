...
def get_segmentation_settings():
    ...
    model_path = r"/home/riley/Documents/GitHub/TextCollage/models/openvino/best.xml"
    print(f"Using model: {model_path}")
    
    # Classes to render
    default_classes = ["label", "barcode", "map"]
...
if __name__ == "__main__":
    ...
    print("This script is designed to be used as part of the main Transcriber CLI pipeline.")
